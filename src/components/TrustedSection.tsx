...
const TrustedSection = () => {
  return (
    <section className="w-full bg-blue-400 py-20 rounded-2xl">
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8" >
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-3xl lg:text-[42px] font-bold text-white mb-8 leading-tight">
          ...
          <div className="mt-12 flex justify-center items-center gap-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-white font-semibold">SSL Secure</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-2">
                <svg className="w-10 h-10 text-blue-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-white font-semibold">PDF Association</span>
            </div>
          </div>
        </div>
      </div>
