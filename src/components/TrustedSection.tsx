    ...
    <section className="w-full bg-blue-400 py-20 rounded-2xl">
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8" >
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-12">
            <button className="bg-white text-blue-600 hover:bg-black hover:text-white transition-colors duration-300 px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl">
              Get Started Now
            </button>
          </div>
        </div>
