    ...
    <section>
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[72px] leading-tight sm:leading-tight font-bold text-blue-600">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4 sm:mt-8">
            <a
              className="inline-block rounded-full border border-[#ffd86f] bg-[#ffd86f] px-5 py-3 text-base font-medium text-black shadow-sm transition-colors hover:border-black hover:text-white hover:bg-black"
              href="#"
            >
              Book A Demo
            </a>
